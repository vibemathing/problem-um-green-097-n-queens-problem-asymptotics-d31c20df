...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-097-n-queens-problem-asymptotics-d31c20df-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-097"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-097-n-queens-problem-asymptotics-d31c20df-v1",
      "problem_contract_sha256": "4c072be8d8c664aa755a86f28c967f2bda85ff2156d735b8b03382556298a228",
      "problem_id": "problem:um-green-097-n-queens-problem-asymptotics-d31c20df",
      "route_id": "route:um-green-097-n-queens-problem-asymptotics-d31c20df-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-097-n-queens-problem-asymptotics-d31c20df-source-fidelity-01",
      "graph_id": "graph:um-green-097-n-queens-problem-asymptotics-d31c20df-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-097-n-queens-problem-asymptotics-d31c20df-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-097-n-queens-problem-asymptotics-d31c20df-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "In how many ways (asymptotically) $Q(n)$ may $n$ non-attacking queens be placed on an $n \\times n$ chessboard?"
          },
          "statement_sha256": "5ff1789b166b92990b28816ac401033498e5b2d0309626a48f17253e96772c61"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-097-n-queens-problem-asymptotics-d31c20df-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-097-n-queens-problem-asymptotics-d31c20df-root",
      "route_id": "route:um-green-097-n-queens-problem-asymptotics-d31c20df-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-097-bb5cbff7754b",
        "url": "https://www.unsolvedmath.com/problems/GREEN-097"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
