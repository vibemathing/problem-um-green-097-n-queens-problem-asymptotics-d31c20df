...
- Repository: `vibemathing/problem-um-green-097-n-queens-problem-asymptotics-d31c20df`
- Repository binding: `verified`
- Repository database ID: `1359418496`
- Repository node ID: `R_kgDOUQcUgA`
- Default branch: `main`
- Visibility: `public`
- Canonical Problem: `problem:um-green-097-n-queens-problem-asymptotics-d31c20df`
- ProblemContract SHA-256: `4c072be8d8c664aa755a86f28c967f2bda85ff2156d735b8b03382556298a228`
...
- Harness snapshot SHA-256: `c2cfb6fa3ca8fc10c2d3ebfec17b10656f7f78f59c029a8128c612eb94461690`
